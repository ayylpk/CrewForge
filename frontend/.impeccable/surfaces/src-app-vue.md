...
related_targets: ["src/router/index.ts","src/views/LoginView.vue","src/views/ProjectsView.vue","src/views/CreateProjectView.vue","src/views/ArchitectView.vue","src/views/ExecutionView.vue","src/views/ProjectDetailView.vue"]
---
